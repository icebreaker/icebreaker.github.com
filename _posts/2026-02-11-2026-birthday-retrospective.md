...
title: 2026 Birthday Retrospective
propaganda: hr
music: AzNd30AUVuQ
...
How did it work? It used the limited primitives available `echo`, `choice`,  `if`, `goto`. I was unaware of course of the more advanced capabitilies that were available in the more modern `.cmd` variant of the *language*, that was available in the [NT family][nt].
...
Truth be told, I got my very own *feature phone* quite late in the game, in the form of a glorious [Sony Ericsson K300][sek300], which of course was way more than just a calculator in my pocket.



![sek300](/media/2026/sek300.png)

Thinking about all this made me realize how we all used to explore every nook and cranny of these phones back in the day. And now, we carry phones in our pockets that put absolute *monsters* like the [Pentium 4][p4] to shame in every respect.

Quite an interesting *conondrum* to ponder, isn't it so?

## Blogging

Speaking of firsts, I had my first *homepage* up and running on [Geocities][geocities] in 2002 or so. The idea of *free* *ad-less* hosting was just a dream back in those days, and one frequently ended up hopping between hosts depending on what was being offered.

At any rate, I did have some *articles* and *tutorials* up there, but it most definitely wasn't an actual [blog][blog]. So much so that in fact I can't recall anybody even mentioning the term *blog* until much later into the decade.

I went through what I like to call the right of passage of the *great primordial blog-o-verse*: [Blogger][blogger], [Tumblr][tumblr], [Wordpress.com][wordpress] (*both cloud and self-hosted*), before scraping all the dynamic stuff, and going to back to the basics of having a statically generated site.
...
Now, just so it happens that I found myself working on a very interesting service that intersected at a pretty fundamental level with what I like to call *the dawn* of modern social media. If you ask someone today to name a couple of social media companies from let's say between 2003 to 2009, they will very likely say [MySpace][myspace] and [Facebook][facebook].

I say that, what about [Bebo][bebo], [Friendster][friendster], [Hi5][hi5] or [VK][vk]? Do any of these ring a bell?

The service eventually got sold for a considerable chunk of change way back in 2008, and the rest is history, but you young folks should remember that your elders also used to have [rizz][rizz] and did copious amounts of [aura farming][aurafarming] back in those early days. Even though our bodies might not have been [tea][bodyistea], even back then. Too much non-diet [Coke][coke], I'm afraid.
...
Obviously, I wouldn't host any of the ISOs myself, and I'd offload them to someplace like [archive.org][archive.org].
...
![1](/media/2026/art/1.png)

![2](/media/2026/art/2.png)

![3](/media/2026/art/3.png)

![4](/media/2026/art/4.png)

![5](/media/2026/art/5.png)

![6](/media/2026/art/6.png)

![7](/media/2026/art/7.png)
...
[sek300]: https://www.gsmarena.com/sony_ericsson_k300-pictures-983.php
[p4]: https://en.wikipedia.org/wiki/Pentium_4
[geocities]: https://en.wikipedia.org/wiki/GeoCities
[blog]: https://en.wikipedia.org/wiki/History_of_blogging
...
[vk]: https://en.wikipedia.org/wiki/VK_(company)
[rizz]: https://en.wiktionary.org/wiki/rizz
[bodyistea]: https://en.wiktionary.org/wiki/body_tea
[coke]: https://en.wikipedia.org/wiki/Coca-Cola
[aurafarming]: https://en.wiktionary.org/wiki/aura_farming
[archive.org]: https://en.wikipedia.org/wiki/Internet_Archive
